...
from src.pipeline.prediction_pipeline import PredictionPipelin, CustomClass
...
def prediction_data():
    ...
    pipeline_prediction = PredictionPipelin()
    ...
    if result == 0:
        ...
        return render_template("resul.html", final_result = "Your yearly income is more than $50k:{}".format(result))
